...
# -*- coding: utf-8 -*-
"""
Created on Tue May 30 15:08:30 2017
...
# Saving the split sets:
with open('objs.pickle', 'wb') as f:  
    pickle.dump([X_train, X_test, y_train, y_test], f)

# Getting back the split sets:
...
pickle.dump(classifier, open("arrests-svm-classifier", 'wb'))


# load the model from disk
classifier = pickle.load(open("arrests-svm-classifier", 'rb'))
...
pickle.dump(grid_search, open("arrests-grid-classifier", 'wb'))
